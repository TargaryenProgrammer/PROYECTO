...
$mujeres = isset($_SESSION['carrito']['mujeres']) ? $_SESSION['carrito']['mujeres'] : null;

$lista_carrito = array();

if ($mujeres != null) {
    foreach ($mujeres as $clave => $cantidad) {
        $sql = $con->prepare("SELECT id, nombre, precio, descuento, $cantidad AS cantidad FROM mujeres WHERE id = ? AND activo = 1");
        $sql->execute([$clave]);
...
<body>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php if ($lista_carrito == null) {
                                ...
                                $total = 0;
                                foreach ($lista_carrito as $mujer) {
                                    $_id = $mujer['id'];
                                    $nombre = $mujer['nombre'];
                                    $precio = $mujer['precio'];
                                    $descuento = $mujer['descuento'];
                                    $cantidad = $mujer['cantidad'];
    ...
    <div class="modal fade" id="eliminaModal" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">¿Realmente desea eliminar el mujer de la lista?</div>
    ...
    function actualizaCantidad(cantidad, id) {
        let url = 'clases/actualizar_carrito_mujer.php'
