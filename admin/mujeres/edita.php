...
$sql = $con->prepare("SELECT id, nombre, descripcion, precio, descuento, stock, id_categoria FROM mujeres WHERE id = ? AND activo = 1");
$sql->execute([$id]);
...
$rutaImagenes = '../../images/mujeres/' . $id . '/';
...
<main>
    <div class="container-fluid px-4">
        <h2 class="mt-3">Modificar prenda</h2>
        <form action="actualiza.php" method="post" enctype="multipart/form-data" autocomplete="off">
            ...
            <div class="row">
                ...
                <div class="col mb-3">
                    ...
                    <input type="text" class="form-control" name="descuento" value="<?php echo $mujer['descuento']; ?>"
                        id="descuento" aria-describedby="helpId" required />
                </div>
                <div class="col mb-3">
