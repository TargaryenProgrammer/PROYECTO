<?php
/**
 * Funciones de utilidad para usuarios con rol Administrador
 * Autor: Carlos Romero
 * 
 */
...
{
    $sql = $con->prepare("INSERT INTO clientes(nombres, apellidos, email, telefono, nip, estatus, fecha_alta) VALUES(?,?,?,?,?, 1, now())");
