<?php require_once '../layout/header.php';
    ...
    $fotoRemove = 0;
    $imgPortada = $fotoActual != "" ? '<img id="img" src="'.ADMIN_URL."/images/uploads/".$fotoActual.'">' : "";
    $pageRuta = ADMIN_URL.'/'.$data['infoPage']['ruta'];
 ?>
    ...
    <div class="app-title">
        <div>
            <h1>
                ...
                <a href="<?= ADMIN_URL; ?>/paginas/crear" class="btn btn-primary">
                    <i class="fas fa-plus-circle"></i> Crear página</a>
                <?php } ?>
            </h1>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
            <li class="breadcrumb-item"><a href="<?= ADMIN_URL; ?>/paginas"> Páginas</a> | <a href="<?= $pageRuta ?>"
                    target="_blanck"> <i class="fa fas fa-globe" aria-hidden="true"></i> Ver página</a>
            </li>
        </ul>
    </div>
    <div class="row">
                        ...
                        <div class="col-md-10">
                            <div class="form-group">
                                ...
                                <input class="form-control" id="txtTitulo" name="txtTitulo" type="text"
                                    value="<?= $data['infoPage']['titulo'] ?>" required="">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="tile-footer">
                            <div class="form-group col-md-12">
                                <div id="containerGallery">
                                    <h4>Portada</h4>
                                    <span style="color: red;">Tamaño sugerido (1920px X 239px)</span>
                                </div>
                                <hr>
                                <div id="containerImages">
                                    <div class="photo">
                                        <div class="prevPhoto prevPortada">
                                            <span class="delPhoto noBlock">X</span>
